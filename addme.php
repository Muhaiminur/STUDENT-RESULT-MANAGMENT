...
<fieldset>
<legend><span class="number">1</span> INSERT NEW STUDENT</legend>
</select>
<input type="text" name="field1" placeholder=" NAME" id="f1">
<input type="text" name="field2" placeholder="ROLL NUMBER *" id="f2">
...
$roll = $_POST['field2'];
    ...
    if(isset($_POST['update']))
{
    $sql = "INSERT INTO studentinfo (name, role)
    VALUES ('{$name}', '{$roll}')";
    // use exec() because no results are returned
    $conn->exec($sql);
    echo "New record created successfully";
    echo'<script> window.location="newstudent.php"; </script> ';
    //header("Refresh:0;url=newstudent.php");
}
