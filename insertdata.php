		...
		<div id="logo">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="test.php" accesskey="5" title="">UNIVERSITY</a></li>
...
{
echo "<option value='" . $row['id'] . "'>" . $row['xam'] . "</option>";
}
...
echo "<tr>";
echo "<td>" . $row['id'] . "</td>";
echo "<td><a href='updateform.php'>" . $row['sub'] . "</a></td>";
echo "</tr>";
}
echo "</table>";
