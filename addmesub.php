...
<div id="header-wrapper">
    <div id="header" class="container">
        <div id="logo">
            ...
            <div id="menu">
                <ul class="menu">
                    <li class="current"><a href="newstudent.php" accesskey="1" title="">NEW STUDENT</a></li>
...
<form method="post" action="addmesub.php">
<fieldset>
<legend><span class="number">1</span> INSERT NEW SUBJECT</legend>
</select>
<input type="text" name="field1" placeholder=" SUBJECT NAME" id="f1">
